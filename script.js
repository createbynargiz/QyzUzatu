let targetDate=new Date("2025-10-27T00:00:00")
...
form.addEventListener("submit", e => {
  ...
  fetch("https://script.google.com/macros/s/AKfycbzS_Vz5nWsD_xFNHXxzEGuI_ZMW5ZCFhXIVqNROKDo0LJj1--LoroV3OC7i5RkgTnn52Q/exec", {
    method: "POST",
    body: data
  })
  .then(res => res.text())
